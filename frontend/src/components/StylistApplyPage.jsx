...
export default function StylistApplyPage({ setPage }) {
  ...
  if (message) {
    return (
      <>
        <PageHero title="Application submitted" text="Your professional account is now waiting for admin review." icon={<CheckCircle2 />} />
        <section className="application-success">
          <div className="application-success-card">
            ...
            <p>Your details and verification documents have been received. An admin will review your identity, business information, and workspace evidence before your profile becomes visible to customers.</p>
  ...
  return (
    <>
      ...
      <form className="legal-page stylist-apply-form" onSubmit={submit}>
        <div className="note-box prep">Your profile stays private until admin approval. This helps keep the marketplace safe and trusted for customers.</div>
        ...
        <p className="form-helper">Upload clear documents so admin can confirm the business is real before approving your profile.</p>
